...
"fn.r" contains code of the linkages and clustering algorithms; 
"simu.r" contains code of simulations;
"eeg2.r" contains code of epilepsy EEG data applications. 
"pgshort2.rdata" is the SDFs (smoothed periodograms) of the 500 people, which used in epilepsy EEG data applications.

Note that to run the code, you need a valid gurobi account, visit https://www.gurobi.com/ for details.
